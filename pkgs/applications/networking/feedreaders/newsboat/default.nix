...
rustPlatform.buildRustPackage rec {
  ...
  # https://github.com/NixOS/nixpkgs/pull/98471#issuecomment-703100014
  GETTEXT_LIB_DIR = stdenv.lib.optionalString stdenv.isDarwin
    "${stdenv.lib.getLib gettext}/lib";
  GETTEXT_INCLUDE_DIR = stdenv.lib.optionalString stdenv.isDarwin
    "${stdenv.lib.getDev gettext}/include";
  GETTEXT_BIN_DIR = stdenv.lib.optionalString stdenv.isDarwin
    "${stdenv.lib.getBin gettext}/bin";
  ...
  meta = with stdenv.lib; {
    ...
    # Darwin build started faling since 2.21, see https://github.com/NixOS/nixpkgs/pull/98471#issuecomment-696835913
